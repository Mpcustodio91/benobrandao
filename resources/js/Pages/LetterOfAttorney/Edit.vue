...
export default defineComponent({
  ...
  methods: {
    update() {
      this.form.patch(`/letter-of-attorneys/${this.contract.id}`);
    },
    onReady(editor) {      
  ...
  mounted() {
    ...
    this.form.companie_id = this.letter.companie.id
    this.form.description = this.letter.description
  },
  props: {
    data: Object,
    letter: Object
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="mt-3 btn-group">
                  <Link :href="`/letter-of-attorneys`" class="btn btn-sm btn-danger">Voltar</Link>
